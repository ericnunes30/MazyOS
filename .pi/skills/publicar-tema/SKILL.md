...
- **Skill carrossel:** `.pi/skills/carrossel/SKILL.md` — usar pra fase do carrossel
...
**Sem perguntar, partir direto pra criação do carrossel** chamando `.pi/skills/carrossel/SKILL.md` (tipo 1: carrossel texto puro).
